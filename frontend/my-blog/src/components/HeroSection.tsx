    ...
    <div className='w-full'>
        <div className='flex flex-col gap-10 justify-center items-center px-10'>
                ...
                <div className='w-full flex justify-center'>
                    <Link to='signup'>
                        <button className='px-4 py-2 bg-indigo-500 hover:bg-indigo-400 shadow-md rounded-lg text-white text-lg transition-all duration-300 ease-in-out hover:scale-105'>
                            Register
                        </button>
                    </Link>
                </div>
